		...
		<?php if ($row['perfil'] != 2): ?>
			<div class="grilla">
				...
				<div class="celda celdax80">
					...
					<section class="cotenidoAlbum">
						<div class="cierreCampania">
							<h1>Gracias por tu participación!!!</h1>
							<h2>Con tu apoyo lograremos cuidar el ambiente y darles una gran enseñanza a las próximas generaciones</h2>
							<br>
							<h1>Juntos lo lograremos</h1>
						</div>
