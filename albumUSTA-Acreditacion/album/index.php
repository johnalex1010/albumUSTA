...
error_reporting (E_ALL & ~E_NOTICE & ~E_DEPRECATED);
	...
	if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
		...
		require_once("../components/otros/queryTablaPosicion.php");
		require_once("../components/otros/queryGrupos.php");
...
switch ($op) {
	case 'perfil':
		...
		break;
	case 'asiVaElMundial':
		$contenido = "pages/asiVaElMundial.php";
		$url = "?op=laminitas";
		$txt = "Volver al álbum";
		break;
	case 'equipos':
		$contenido = "pages/equipos.php";
		$url = "?op=laminitas";
		$txt = "Volver al álbum";
		break;
	case 'premios':
...
<body>
				...
				<div class="panelControl">
					...
					<nav>
						<ul>
							...
							<li><a href="album/?op=asiVaElMundial"><span class="icon-campPlay"></span>  <span class="txt_panel">Asi va el mundial</span></a></li>
							<li><a href="album/?op=equipos"><span class="icon-team"></span>  <span class="txt_panel">Equipos</span></a></li>
	...
	<footer class="footerAlbum">
		...
		<p>Mundial de la Excelencia USTA - 2018</p>
		<p>Institución de Educación Superior a la inspección y vigilancia del Ministerio de Educación Nacional - SNIES 1704</p>
